...
const appClassic = strip(fs.readFileSync(path.join(root, 'ui', 'classic', 'app.js'), 'utf8'))
const appProto = strip(fs.readFileSync(path.join(root, 'ui', 'proto', 'app.js'), 'utf8'))
const sharedDir = path.join(root, 'ui', 'shared')
let findings = 0
